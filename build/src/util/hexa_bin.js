...
function hexa_bin_Bitmap(DEs) {
    ...
    for (let i = 0; i < 63; i++) {
        i = i + 3;
        json_bitmaps.hexaPB = json_bitmaps.hexaPB.concat(hexa(json_bitmaps.binaryPB.substr(i - 3, 4)));
    }
    for (let i = 0; i < 63; i++) {
        i = i + 3;
        json_bitmaps.hexaSB = json_bitmaps.hexaSB.concat(hexa(json_bitmaps.binarySB.substr(i - 3, 4)));
    }
    function hexa(str) {
        switch (str) {
            case "0000":
...
exports.hexa_bin_Bitmap = hexa_bin_Bitmap;
/**
 *
...
exports.numberOfDataElements = numberOfDataElements;
/**
